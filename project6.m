...
s(33,48)=1; s(33,81)=1; s(34,33)=1; s(34,35)=1; s(34,51)=1;
s(35,26)=1; s(35,34)=1; s(35,36)=1; s(36,35)=1; s(36,38)=1;
s(36,54)=1; s(37,28)=1; s(37,38)=1; s(37,39)=1; s(38,36)=1;
s(38,37)=1; s(38,57)=1; s(39,37)=1; s(39,40)=1; s(40,39)=1;
s(41,29)=1; s(41,42)=1; s(41,64)=1; s(42,30)=1; s(42,41)=1;
s(43,31)=1; s(43,44)=1; s(44,43)=1; s(44,45)=1; s(45,44)=1;
s(45,46)=1; s(45,63)=1; s(46,45)=1; s(46,47)=1; s(46,58)=1;
s(47,32)=1; s(47,46)=1; s(47,48)=1; s(47,81)=1; s(48,33)=1;
s(48,47)=1; s(48,49)=1; s(48,81)=1; s(49,48)=1; s(49,50)=1;
s(49,60)=1; s(50,49)=1; s(50,51)=1; s(50,82)=1; s(51,34)=1;
s(51,50)=1; s(51,52)=1; s(51,83)=1; s(52,51)=1; s(52,53)=1;
s(52,56)=1; s(53,52)=1; s(53,54)=1; s(54,36)=1; s(54,53)=1;
s(54,55)=1; s(55,54)=1; s(55,56)=1; s(55,57)=1; s(56,52)=1;
s(56,55)=1; s(56,73)=1; s(57,38)=1; s(57,55)=1; s(57,76)=1;
s(58,46)=1; s(58,59)=1; s(58,60)=1; s(59,61)=1; s(59,63)=1;
s(59,68)=1; s(60,49)=1; s(60,58)=1; s(60,61)=1; s(61,59)=1;
s(61,60)=1; s(61,62)=1; s(62,61)=1; s(62,70)=1; s(62,82)=1;
s(63,45)=1; s(63,59)=1; s(63,64)=1; s(64,41)=1; s(64,63)=1;
s(64,65)=1; s(65,64)=1; s(65,66)=1; s(66,65)=1; s(66,67)=1;
s(67,66)=1; s(67,68)=1; s(68,59)=1; s(68,67)=1; s(68,69)=1;
s(69,68)=1; s(69,70)=1; s(69,77)=1; s(70,62)=1; s(70,69)=1;
s(70,71)=1; s(70,78)=1; s(71,70)=1; s(71,72)=1; s(71,79)=1;
s(71,83)=1; s(72,71)=1; s(72,73)=1; s(73,56)=1; s(73,72)=1;
s(73,74)=1; s(74,73)=1; s(74,75)=1; s(75,74)=1; s(75,76)=1;
s(76,57)=1; s(76,75)=1; s(77,69)=1; s(77,78)=1; s(78,70)=1;
s(78,77)=1; s(78,79)=1; s(79,71)=1; s(79,78)=1; s(80,22)=1;
s(80,32)=1; s(81,32)=1; s(81,33)=1; s(81,47)=1; s(81,48)=1;
...
for ii = 1:num-1
    pick_x = [pick_x, X(ii)]; %原本的點
    pick_y = [pick_y, Y(ii)];

    %新增一些點，用於找多項式
    for jj = 1:19 %轉折處強化(多給一些點，讓他更貼近真實情況)
        pick_x = [pick_x, (X(ii)*(100-jj) + X(ii+1)*jj)/100];
        pick_y = [pick_y, (Y(ii)*(100-jj) + Y(ii+1)*jj)/100];
    end
    for jj = 20:2:80 %中間段平均給點
        pick_x = [pick_x, (X(ii)*(100-jj) + X(ii+1)*jj)/100];
        pick_y = [pick_y, (Y(ii)*(100-jj) + Y(ii+1)*jj)/100];
    end
    for jj = 81:99 %轉折處強化(多給一些點，讓他更貼近真實情況) 
        pick_x = [pick_x, (X(ii)*(100-jj) + X(ii+1)*jj)/100];
        pick_y = [pick_y, (Y(ii)*(100-jj) + Y(ii+1)*jj)/100];
    end
end
pick_x = [pick_x, X(num)]; %原本的點
pick_y = [pick_y, Y(num)];
% disp([pick_x', pick_y']);
n = size(pick_x, 2); %新點
d = 20;  %設為20次多項式(太大會產生問題)
t = linspace(1, n, 100); 
px = polyfit(1:n, pick_x, d);  %x,y分別找出"最接近"的參數多項式
py = polyfit(1:n, pick_y, d);
fx = polyval(px, t);
fy = polyval(py, t);
plot(fx, fy, '-k', 'LineWidth', 3);  %最後將圖形畫出
